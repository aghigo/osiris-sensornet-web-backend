...
public class AvailableMessageGroupListConfig {
    ...
    public void readConfigurations() throws IOException {
        ...
        this.messageGroupConfigList = new ArrayList<>();
        for(String messageGroupName : this.messageGroupNameList) {
            if(properties.getProperty("osiris.messagegroup." + messageGroupName + ".name") != null) {
                MessageGroupConfig messageGroupConfig = MessageGroupConfig.builder()
                        ...
                        .build();
                this.messageGroupConfigList.add(messageGroupConfig);
            }
        }
    }
}
